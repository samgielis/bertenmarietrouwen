import { Flex, Container, VStack, Heading, Text, Stack, StackDivider, useBreakpointValue, StackDirection, Box, Center } from "@chakra-ui/react"
...
export const SaveTheDate = () => {
  ...
  return <Flex h="100vh" justify={"center"} align={"center"}>
    ...
    <Container textAlign="center" p={5} py={10}>
      ...
      <Stack divider={<StackDivider />} direction={direction} spacing={sectionSpacing}>
        <Center>
          <VStack spacing={24}>
